...
public class ConnectFourControl {
	...
	public void checkCol2(){
		...
		if(cont[1][2]!=0){
				System.out.println(" you reach the column 2 full. -----------------------------");
				if(player == 2){
						player=player-1;
					}
				else{
	...
	public void checkCol3(){
		...
		if(cont[1][3]!=0){System.out.println("  you reach the column 3 full. -----------------------------");
		if(player == 2){
				player=player-1;
			}
			else{
	...
	public void checkCol4(){
		...
		if(cont[1][4]!=0){System.out.println(" you reach the column 4 full. -----------------------------");
		if(player == 2){
				player=player-1;
			}
	...
	public void checkCol5(){
		...
		if(cont[1][5]!=0){System.out.println("  you reach the column 5 full. -----------------------------");
		if(player == 2){
				player=player-1;
				}
				else{
	...
	public void checkCol6(){
		...
		if(cont[1][6]!=0){System.out.println("  you reach the column 6 full.  -----------------------------");
	...
	public void checkCol7(){
		...
		if(cont[1][7]!=0){System.out.println("  you reach the column 7 full.  -----------------------------");
		if(player == 2){
				player=player-1;
			}
			else{
